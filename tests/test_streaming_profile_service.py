...
from ids_platform.streaming.evaluation.orchestration.profile_service import (
    ProfileExecutionOptions,
    ProfileListFilters,
    list_profiles,
    run_profile,
)
from ids_platform.streaming.evaluation.orchestration.profile_runner import resolve_profile
...
class ProfileServiceTests(unittest.TestCase):
    def test_local_profile_aliases_resolve_to_current_profiles(self) -> None:
        profiles = {
            ...
            "layer_a_local_medium": {
                ...
                "args": {"summary_csv": "artifacts/streaming/evaluation/layer_a_summary_local_medium.csv"},
            },
            ...
            "layer_b_local_medium": {
                ...
                "runtime": "docker",
                "meta": {"resource_class": "medium"},
                "args": {"summary_csv": "artifacts/streaming/evaluation/layer_b_summary_local_medium.csv"},
            },
            "watermark_local_light": {"extends": "watermark_local_medium"},
            "watermark_local_medium": {
                "script": "scripts/streaming/official/run_watermark_matrix.py",
                "runtime": "docker",
                "meta": {"resource_class": "medium"},
                "args": {"summary_csv": "artifacts/streaming/evaluation/watermark_summary_local_medium.csv"},
            },
            "layer_c_local_light": {"extends": "layer_c_local_medium"},
            "layer_c_local_medium": {
                "script": "scripts/streaming/official/run_layer_c_matrix.py",
                "runtime": "host",
                "meta": {"resource_class": "medium"},
                "args": {"summary_csv": "artifacts/streaming/evaluation/layer_c_summary_local_medium.csv"},
            },
            "stress_local_light": {"extends": "stress_local_medium"},
            "stress_local_medium": {
                "script": "scripts/streaming/official/run_load_quality_matrix.py",
                "runtime": "docker",
                "meta": {"resource_class": "medium"},
                "args": {"summary_csv": "artifacts/streaming/evaluation/load_quality_summary_local_medium.csv"},
            },
        }
    ...
    def test_run_profile_executes_command_through_injected_runner(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(captured["command"][0:2], ["python", "scripts/streaming/official/run_layer_a_matrix.py"])
