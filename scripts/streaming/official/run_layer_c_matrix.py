...
from ids_platform.streaming.evaluation.matrices.layer_c_fault_matrix import LayerCFaultMatrixOptions, run  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run streaming Layer C fault matrix")
    ...
    parser.add_argument(
        "--scenarios",
        nargs="*",
        default=["kafka_restart", "spark_process_restart", "producer_restart"],
    ...
    parser.add_argument("--summary-csv", type=str, default="artifacts/streaming/evaluation/layer_c_summary.csv")
