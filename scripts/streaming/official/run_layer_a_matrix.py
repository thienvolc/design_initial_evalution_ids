...
from ids_platform.streaming.evaluation.matrices.layer_a_matrix import LayerAMatrixOptions, run  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run streaming Layer A system-knob matrix")
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional runtime baseline mode. Supported: pass_through",
    )
    parser.add_argument(
        "--profiles",
        nargs="*",
    ...
    parser.add_argument(
        "--summary-csv",
        type=str,
        default="artifacts/streaming/evaluation/layer_a_summary.csv",
    )
