...
from ids_platform.streaming.evaluation.orchestration.profile_service import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a streaming evaluation profile from YAML config")
    parser.add_argument(
        "--profile-config",
        type=str,
