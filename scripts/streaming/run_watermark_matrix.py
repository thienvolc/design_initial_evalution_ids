...
from ids_platform.streaming.matrices.watermark_matrix import WatermarkMatrixOptions, run  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--summary-csv",
        type=str,
        default="artifacts/streaming/online/watermark_summary.csv",
    )
