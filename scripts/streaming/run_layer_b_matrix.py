...
from ids_platform.streaming.matrices.layer_b_matrix import LayerBMatrixOptions, run  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run online Layer B model-cost matrix")
    ...
    parser.add_argument(
        "--summary-csv",
        type=str,
        default="artifacts/streaming/online/layer_b_summary.csv",
    )
