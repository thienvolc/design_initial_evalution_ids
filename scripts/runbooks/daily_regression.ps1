...
Write-Host "Recommended official order: smoke -> layer_a_500k -> layer_b_500k -> watermark_500k -> layer_c_700k_fault -> stress_main_testx4"
...
# 4. Optional timeseries plots after benchmark path completes
